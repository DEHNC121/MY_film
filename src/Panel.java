...
// all
    ...
    public int addButoon(String s1) {
        ...
        ActionListener le = (ActionEvent e) -> {
            if  (s1.equals("All"))
            {
                new Window(1000,700, new JScrollPane(new FilmListPanel("all_content_names")),"List of films");
            }else if (s1.equals("Rating")){
                new Window(1000,700, new JScrollPane(new FilmListPanel("all_ratings")),"List of films");

            }else if (s1.equals("Rating films")){
                new Window(1000,700, new JScrollPane(new FilmListPanel("film_ratings")),"List of films");

            }else if (s1.equals("Rating series")){

                new Window(1000,700, new JScrollPane(new FilmListPanel("series_ratings")),"List of films");
